...
type NewRunRequest struct {
	...
	DetectorConfigs *v1.DetectorConfig     `protobuf:"bytes,5,opt,name=detector_configs,json=detectorConfigs,proto3" json:"detector_configs,omitempty"`
...
func (x *NewRunRequest) GetDetectorConfigs() *v1.DetectorConfig {
	if x != nil {
		return x.DetectorConfigs
	}
	return nil
}
...
const file_analysis_v1_analysis_proto_rawDesc = "" +
	...
	"\x02to\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x02to\x12K\n" +
	"\x10detector_configs\x18\x05 \x01(\v2 .pulsoats.core.v1.DetectorConfigR\x0fdetectorConfigs\x12G\n" +
...
var file_analysis_v1_analysis_proto_depIdxs = []int32{
	...
	11, // 6: pulsoats.analysis.v1.NewRunRequest.detector_configs:type_name -> pulsoats.core.v1.DetectorConfig
	12, // 7: pulsoats.analysis.v1.NewRunRequest.filters_configs:type_name -> pulsoats.core.v1.FilterConfig
